...
> *Copyright 2019 [Monica Bustamante](https://monicadatascience.com)*
...
Many personalization settings in `_config.yml`, such as setting your name and site's description, changing the background color/image, setting your avatar to add a little image in the navigation bar, customizing the links in the menus, customizing what social media links to show in the footer, etc.
